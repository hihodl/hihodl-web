...
export const btnSecondary =
  "inline-flex h-12 items-center justify-center gap-2 whitespace-nowrap rounded-[24px] border border-[color:var(--color-hairline-strong)] px-6 text-small font-medium text-sp-ink transition-colors duration-180 hover:bg-sp-ink/5 disabled:cursor-not-allowed disabled:opacity-40";
...
export const btnSmallSecondary =
  "inline-flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded-[20px] border border-[color:var(--color-hairline-strong)] px-5 text-small font-medium text-sp-ink transition-colors duration-180 hover:bg-sp-ink/5 disabled:cursor-not-allowed disabled:opacity-40";

const pillBase =
  "inline-flex h-6 shrink-0 items-center gap-1.5 whitespace-nowrap rounded-[12px] border px-2.5 text-tiny";

export const pill = {
  neutral: `${pillBase} border-[color:var(--color-hairline-strong)] text-sp-ink/85`,
  open: `${pillBase} border-moonlight/40 bg-moonlight/10 text-sp-ink`,
...
export const card =
  "rounded-card border border-[color:var(--color-hairline)] bg-sp-ink/[0.03]";

export const eyebrow = "text-tiny uppercase tracking-wider";

export const input =
  "w-full rounded-input border border-[color:var(--color-hairline-strong)] bg-sp-ink/[0.04] px-4 py-3 text-body text-sp-ink placeholder:text-sp-ink/50 outline-none transition-colors duration-180 focus:border-amber/60";
