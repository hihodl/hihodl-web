...
const SCENES: Scene[] = [
  {
    ...
    timeLabel: "morning",
    eyebrow: "07:14",
    title: "Wake up. Open the app.",
    body: "Your @username, your balance, your accounts. Nothing to pick, nothing to top up. Just money.",
  ...
  },
  {
    ...
    timeLabel: "midday",
    eyebrow: "09:32",
    title: "Move it. Pay nothing.",
    body: "Two taps to change one currency into another, at the rate you were shown. The first $500 you move each month is on us.",
  ...
  },
  {
    ...
    timeLabel: "afternoon",
    eyebrow: "13:07",
    title: "The invoice clears.",
    body: "It lands in minutes, at an address nobody can tie to the last one. You see a clean list of what came in. Nobody else sees anything.",
