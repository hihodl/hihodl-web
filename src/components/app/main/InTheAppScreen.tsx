    ...
    <div className="flex flex-1 flex-col items-center justify-center py-4">
      <section className={`${glass} flex w-full max-w-[560px] flex-col gap-5 p-6 sm:p-8`}>
        ...
        <div className="rounded-[14px] border border-white/10 bg-white/[0.04] px-4 py-3">
          <p className="text-small font-medium text-text">{t("menu.inTheApp.title")}</p>
          <p className="mt-0.5 text-tiny text-[#9FB7C2]">{t("menu.inTheApp.body")}</p>
        </div>
        <StoreButtons />
      </section>
    </div>
