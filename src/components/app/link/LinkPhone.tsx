...
const WHY = "Your linked phone approves and signs, in the HOLD app, every payment you start on the web.";
...
export function LinkView({ phase, actions }: { phase: LinkPhase; actions: LinkActions }) {
  ...
  if (phase.kind === "waiting") {
    ...
    return (
      <div>
        <StepDesc>{WHY} Scan this code with your phone&apos;s camera, or from the HOLD app.</StepDesc>
        <div className="mt-3">
        ...
        <p className="mt-4 text-[14px] text-white/60">
          HOLD opens on your iPhone or Android phone and shows a six-digit code. No HOLD yet? The code shows where to get it.
        </p>
  ...
  return (
    <div>
      <ReadyBox title="Your phone is linked" line="Payments you start on the web are now approved and signed in the HOLD app on this phone." />
      <Cta>
