 ...
 *    rate through the tier's fee before it is displayed. What HIHODL keeps is
 *    not on this page — it is on /fees, linked from every table.
 *
          ...
          <div className="container-page section relative">
            ...
            <ul className="mt-8 flex flex-col gap-2 max-w-3xl">
              ...
              <Note>
                ...
                shows what we keep on each of these.
              </Note>
            </ul>
          </div>
        </section>
          ...
          <div className="container-page section relative">
            ...
            <ul className="mt-8 flex flex-col gap-2 max-w-3xl">
              ...
              <Note>
                ...
                share of the interest. Other plans earn less;{" "}
                <Link href="/fees" className="text-amber hover:underline">
                  the fee schedule
                </Link>{" "}
                has the exact split.
