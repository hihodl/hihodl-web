          ...
          <div className="flex flex-col gap-8 text-[#eaf6ffff] font-['Inter'] font-[400] leading-relaxed">
            <section className="flex flex-col gap-4">
              <p className="text-[#94a3b8ff]">
                This disclosure explains how tokenized stocks work inside the HOLD app. It applies to HIHODL TECHNOLOGIES OÜ, a company incorporated in Estonia (&quot;HOLD&quot;, &quot;we&quot;, &quot;us&quot;). Read it together with our{" "}
            ...
            <section className="flex flex-col gap-4">
              <h2 className="text-2xl font-[700] text-[#eaf6ffff]">2. HOLD&apos;s role — a non-custodial, passive interface</h2>
              <p className="text-[#94a3b8ff]">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4 text-[#94a3b8ff]">
                <li>HOLD is <span className="text-[#eaf6ffff] font-[600]">not a broker-dealer, exchange, investment firm, financial adviser, or issuer</span>, and does not provide investment advice, portfolio management, or personal recommendations.</li>
                <li>HOLD does not issue, mint, redeem, hold, or take custody of tokenized stocks. The tokens are generated and held under your sole control in your own wallet, on the Solana network.</li>
                <li>HOLD does not match orders, operate an order book, act as counterparty to your trade, or hold client money or client assets.</li>
                <li>When you buy or sell a tokenized stock, <span className="text-[#eaf6ffff] font-[600]">you</span> initiate and authorize a peer-to-pool swap that executes against public, third-party on-chain liquidity (a decentralized exchange aggregator). HOLD provides only the interface that helps you construct and broadcast that transaction from your own keys.</li>
              </ul>
              <p className="text-[#94a3b8ff]">
            ...
            <section className="flex flex-col gap-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4 text-[#94a3b8ff]">
                ...
                <li>The transaction is a token swap executed on-chain against third-party liquidity. Prices are set by that market, not by HOLD, and can differ from the last-traded price of the underlying share and from the price shown before you confirm.</li>
