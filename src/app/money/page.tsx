...
/**
 * The money app, as it was the homepage until Spaces became the story on "/".
 * Moved whole, section ids included: the nav, the footer and every download
 * CTA link here by anchor (`/money#payments`, `/money#download`).
 */
