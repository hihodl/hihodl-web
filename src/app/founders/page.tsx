 ...
 *
 * No rate on this page states what HOLD keeps. Each product states its own
 * take on its own page — /savings for the savings share, /hipoints for the
 * plans — and there is deliberately no aggregate fee schedule to point at.
 * Everything here is what the buyer receives, net.
 */
          ...
          <div className="container-page section relative">
            ...
            <div className="mt-14 max-w-3xl flex flex-col gap-4">
              ...
              <Answer
                ...
                a="No, and that does not change with a Founder Pass. HOLD is a stablecoin wallet where you hold the keys. The pass changes your terms, never your custody."
              />
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className="container-page py-20 md:py-28 relative text-center">
            ...
            <p className="mt-8 text-small text-text-faint">
              ...
              {FOUNDER_PASS.refundWindowMonths} months. This is a one-time price
              with nothing recurring behind it — every product it unlocks states
              what we make on it, on that product&rsquo;s own page.
            </p>
          </div>
        </section>
      </main>
