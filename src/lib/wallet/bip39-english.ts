/**
 * The BIP-39 English wordlist, 2048 words, in order.
 *
 * Vendored because @scure/bip39 is not installed in this repo. Copied from the
 * wallet app's own `bip39@3.1.0` (src/wordlists/english.json) so the web and the
 * app read the same list; scripts/wallet-crypto-check.ts proves the two agree
 * word for word and against the official BIP-39 test vectors.
 *
 * sha256 of the words joined by "\\n" plus a trailing "\\n": 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda
 * (the canonical english.txt from the bitcoin/bips repository).
 */
